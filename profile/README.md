...
| **Widgets** | [Zabbix UI Widgets chessMAX](https://github.com/initMAX/Zabbix-UI-Widgets-chessMAX) | Chess on the Zabbix dashboard - play against the built-in engine, a colleague on another dashboard, or two players at one screen. | <img src="./FREE.png" height="20"> |
